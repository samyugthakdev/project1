...
/**
 * Servlet implementation class Eyevalid
 */
@WebServlet("/Eyevalid")
public class Eyevalid extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try 
		  {  
		    ...
		    int rs=st.executeUpdate("insert into eye_app(uname,gender,age,phn_num,email_id,date_of_birth,dno,street,city,district,state)values('"+name+"','"+gen+"','"+age+"','"+num+"','"+mailid+"','"+dob+"','"+doornum+"','"+street+"','"+city+"','"+district+"','"+state+"')");
