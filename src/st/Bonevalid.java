...
/**
 * Servlet implementation class Bonevalid
 */
@WebServlet("/Bonevalid")
public class Bonevalid extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try 
		  {  
		    ...
		    System.out.print("<h1>Insert successfull</h1>");ServletContext sc = getServletContext();
