...
/**
 * Servlet implementation class Hvalid
 */
@WebServlet("/Hvalid")
public class Hvalid extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try 
		  {  
		    ...
		    int rs=st.executeUpdate("insert into heart_app(uname,gender,age,phn_num,email_id,date_of_birth,dno,street,city,district,state)values('"+name+"','"+gen+"','"+age+"','"+num+"','"+mailid+"','"+dob+"','"+doornum+"','"+street+"','"+city+"','"+district+"','"+state+"')");
